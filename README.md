...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fdb242a0-08b9-45ae-9210-8eca5f862be1
```

> `fdb242a0-08b9-45ae-9210-8eca5f862be1` is the password of the certificate, you can change it to any password you want.
